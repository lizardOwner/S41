...
# Bot initialization
BOT_TOKEN = "8033627387:AAHZ9i80-2q3WCKK-wI9oZxk_Sj492zak9g"  # Replace with your bot token
bot = telebot.TeleBot(BOT_TOKEN)

# Admin IDs
admin_id = ["6536806483"]  # Replace with your Telegram user ID

# Group ID where feedback will be forwarded
GROUP_ID = "-1002393668447"  # Replace with your group chat ID

# Channel ID to verify user membership
CHANNEL_ID = "@Lizard_cheats"  # Replace with your channel username
...
# Constants
max_daily_attacks = 5  # Maximum allowed attacks per user per day
    ...
    if user_id in allowed_user_ids:
        try:
            ...
            if member.status in ['member', 'administrator']:
                ...
                subprocess.run(f"./S4 {target} {port} {duration} 10 100", shell=True)
